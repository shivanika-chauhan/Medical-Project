...
const PersonalCare = () => {
  ...
  // Filter only Personal Care category
  const personalCareItems = products.filter(
    (p) => p.category.toLowerCase() === "personalcare"
  );

  const [showAll, setShowAll] = useState(false);
  const itemsToShow = showAll ? personalCareItems : personalCareItems.slice(0, 10);
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white shadow-lg rounded-xl p-6 md:p-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Personal care plays an essential role in maintaining your overall
            health and well-being. From skincare routines to oral hygiene, hair
            care, and hygiene products, taking care of your body is the first
            step towards feeling confident and staying healthy.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
            Our personal care selection is curated to meet the needs of every
            individual, offering safe and effective solutions for daily
            self-care. Whether you're looking for natural products, premium
            brands, or affordable essentials, we've got you covered.
          </p>
          <p className="text-gray-700 leading-relaxed">
            By prioritizing personal care, you invest in your long-term health.
            Discover a variety of products designed to nourish, protect, and
            enhance your well-being every day.
          </p>
        </div>
      </section>
